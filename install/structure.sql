...
--
-- Host: localhost
-- Erstellungszeit: 07. Juli 2009 um 21:19
...
CREATE TABLE IF NOT EXISTS `hc_bibliographies` (
...
CREATE TABLE IF NOT EXISTS `hc_bibliographies_relations` (
  `id` int(11) unsigned NOT NULL auto_increment,
  ...
  KEY `pages` (`pages`(8))
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Connects relation to 
bibliography';
...
CREATE TABLE IF NOT EXISTS `hc_bibliographies_vertices` (
  `id` int(11) unsigned NOT NULL auto_increment,
  ...
  KEY `bibliography_id` (`bibliography_id`),
  KEY `pages` (`pages`(8))
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Connects objects to 
bibliography';
...
CREATE TABLE IF NOT EXISTS `hc_inferences` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `created` datetime default NULL,
  `modified` datetime default NULL,
  `creator_id` int(11) unsigned NOT NULL default '0',
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Keeps data of 
inferences';
...
CREATE TABLE IF NOT EXISTS `hc_inference_types` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Typification of 
inferences';
...
CREATE TABLE IF NOT EXISTS `hc_pictograms` (
  `id` int(11) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `hc_relations` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `created` datetime default NULL,
  `modified` datetime default NULL,
  `creator_id` int(11) unsigned NOT NULL default '0',
  ...
  KEY `deleted` (`deleted`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Keeps relations between 
objects';
...
CREATE TABLE IF NOT EXISTS `hc_relation_classes` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `created` datetime default NULL,
  `modified` datetime default NULL,
  `creator_id` int(11) unsigned NOT NULL default '0',
  ...
  KEY `title` (`title`(6)),
  KEY `deleted` (`deleted`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Keeps data on classes of 
relations';
...
CREATE TABLE IF NOT EXISTS `hc_relation_types` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `created` datetime default NULL,
  `modified` datetime default NULL,
  `creator_id` int(11) unsigned NOT NULL default '0',
  ...
  KEY `deleted` (`deleted`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Keeps the types of 
objects';
...
CREATE TABLE IF NOT EXISTS `hc_table_updates` (
  `id` int(10) unsigned NOT NULL,
  `key` varchar(32) NOT NULL,
  `status` tinyint(4) NOT NULL default '1',
  PRIMARY KEY  (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Keeps status updates for 
external processes.';
...
CREATE TABLE IF NOT EXISTS `hc_tagsets` (
  `id` int(10) unsigned NOT NULL auto_increment,
  ...
  KEY `title` (`title`(12)),
  KEY `group` (`group`(12))
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Keeps sets of vertices 
and relations.';
...
CREATE TABLE IF NOT EXISTS `hc_vertex_classes` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `created` datetime default NULL,
  `modified` datetime default NULL,
  `creator_id` int(11) unsigned NOT NULL default '0',
...
CREATE TABLE IF NOT EXISTS `hc_vertex_types` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `created` datetime default NULL,
  `modified` datetime default NULL,
  `creator_id` int(11) unsigned NOT NULL default '0',
  ...
  KEY `deleted` (`deleted`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Keeps data on types of 
vertices';
...
CREATE TABLE IF NOT EXISTS `hc_vertices` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `created` datetime default NULL,
  `modified` datetime default NULL,
  `creator_id` int(11) unsigned NOT NULL default '0',
